...
var ASM_CONSTS = {
  93480: () => { if (document.fullscreenElement) return 1; },  
 93526: () => { return document.getElementById('canvas').width; },  
 93578: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93646: () => { document.exitFullscreen(); },  
 93673: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93746: () => { if (document.fullscreenElement) return 1; },  
 93792: () => { return document.getElementById('canvas').width; },  
 93844: () => { return screen.width; },  
 93869: () => { document.exitFullscreen(); },  
 93896: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94029: () => { return window.innerWidth; },  
 94055: () => { return window.innerHeight; },  
 94082: () => { if (document.fullscreenElement) return 1; },  
 94128: () => { return document.getElementById('canvas').width; },  
 94180: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94248: () => { if (document.fullscreenElement) return 1; },  
 94294: () => { return document.getElementById('canvas').width; },  
 94346: () => { return screen.width; },  
 94371: () => { return window.innerWidth; },  
 94397: () => { return window.innerHeight; },  
 94424: () => { if (document.fullscreenElement) return 1; },  
 94470: () => { return document.getElementById('canvas').width; },  
 94522: () => { return screen.width; },  
 94547: () => { document.exitFullscreen(); },  
 94574: () => { if (document.fullscreenElement) return 1; },  
 94620: () => { return document.getElementById('canvas').width; },  
 94672: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94740: () => { document.exitFullscreen(); },  
 94767: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 94825: () => { return screen.width; },  
 94850: () => { return screen.height; },  
 94876: () => { return window.screenX; },  
 94903: () => { return window.screenY; },  
 94930: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94983: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95054: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95111: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95367: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95438: () => { if (document.fullscreenElement) return 1; },  
 95484: () => { return window.innerWidth; },  
 95510: () => { return window.innerHeight; },  
 95537: () => { if (document.pointerLockElement) return 1; }
};
