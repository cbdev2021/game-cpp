...
var ASM_CONSTS = {
  93656: () => { if (document.fullscreenElement) return 1; },  
 93702: () => { return document.getElementById('canvas').width; },  
 93754: () => { return parseInt(document.getElementById('canvas').style.width); },  
 93822: () => { document.exitFullscreen(); },  
 93849: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93922: () => { if (document.fullscreenElement) return 1; },  
 93968: () => { return document.getElementById('canvas').width; },  
 94020: () => { return screen.width; },  
 94045: () => { document.exitFullscreen(); },  
 94072: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 94205: () => { return window.innerWidth; },  
 94231: () => { return window.innerHeight; },  
 94258: () => { if (document.fullscreenElement) return 1; },  
 94304: () => { return document.getElementById('canvas').width; },  
 94356: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94424: () => { if (document.fullscreenElement) return 1; },  
 94470: () => { return document.getElementById('canvas').width; },  
 94522: () => { return screen.width; },  
 94547: () => { return window.innerWidth; },  
 94573: () => { return window.innerHeight; },  
 94600: () => { if (document.fullscreenElement) return 1; },  
 94646: () => { return document.getElementById('canvas').width; },  
 94698: () => { return screen.width; },  
 94723: () => { document.exitFullscreen(); },  
 94750: () => { if (document.fullscreenElement) return 1; },  
 94796: () => { return document.getElementById('canvas').width; },  
 94848: () => { return parseInt(document.getElementById('canvas').style.width); },  
 94916: () => { document.exitFullscreen(); },  
 94943: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 95001: () => { return screen.width; },  
 95026: () => { return screen.height; },  
 95052: () => { return window.screenX; },  
 95079: () => { return window.screenY; },  
 95106: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 95159: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 95230: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 95287: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 95543: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 95614: () => { if (document.fullscreenElement) return 1; },  
 95660: () => { return window.innerWidth; },  
 95686: () => { return window.innerHeight; },  
 95713: () => { if (document.pointerLockElement) return 1; }
};
